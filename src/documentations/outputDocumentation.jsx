...
function OutputDocumentation(){
    return(
        <div className="outputdoc">
            ...
            <p style={{color: "#16cdfa", marginTop: "1.8rem"}}>TYPE-2</p>
            ...
            <p>For word <span style={{fontWeight: "bolder"}}>"east"</span></p>
            <p>Output file contains <span style={{color: "#16cdfa", fontWeight: "bold"}}>"east : 'FILE1'"</span></p>
            <p>Similarly, for word <span style={{fontWeight: "bolder"}}>"west"</span></p>
            <p>Output file contains <span style={{color: "#16cdfa", fontWeight: "bold"}}>"west : 'FILE2'"</span></p>
