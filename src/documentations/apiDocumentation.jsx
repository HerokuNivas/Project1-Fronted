...
function ApiDocumentation(){
    return(
        <div className="apidoc">
            <h3 style={{color: "#2699c7", marginBottom: "1.8rem"}}>API Documentation</h3>
            <p>1. Create a GITHUB account if you don't have one.</p>
            <p style={{marginLeft: "25px"}}>Click <a className="apiLink" style={{color:"#2699c7"}} href="https://github.com/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F&source=header-home" rel="noopener noreffer" target="_blank">here </a>to create a GITHUB account.</p>
            <p>2. Click <a className="apiLink" href="https://github.com/settings/tokens" style={{color: "#2699c7"}} rel="noopener noreffer" target="_blank">here </a>to generate an API Key.</p>
            ...
            <div style={{marginTop: "1.8rem"}} ><img src={image2} width={"80%"} height={"80%"}/></div>
            <div style={{marginTop: "1.8rem"}} ><img src={image3} width={"80%"} height={"80%"}/></div>
        </div>
    )
}
