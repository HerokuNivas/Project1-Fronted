...
function ApiDocumentation(){
    return(
        <div className="apidoc">
            ...
            <p style={{marginLeft: "25px"}}>Click <a className="apiLink" style={{color:"#16cdfa"}} href="https://github.com/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F&source=header-home" rel="noopener noreffer" target="_blank">here </a>to create a GITHUB account.</p>
            <p>2. Click <a className="apiLink" href="https://github.com/settings/tokens" style={{color: "#16cdfa"}} rel="noopener noreffer" target="_blank">here </a>to generate an API Key.</p>
