...
function RepoDocumentation(){
    return(
        <div className='repodoc'>
            <h3 style={{color: "#2699c7", marginTop: "2.5rem", marginBottom: "1.8rem"}}>Repository Documentation</h3>
            <p>1. Create an Empty Respository in GITHUB.</p>
            <p style={{marginLeft: "25px"}}>Click <a className="repoLink" style={{color:"#2699c7"}} href="https://github.com/new" rel="noopener noreffer" target="_blank">here </a>to create repository.</p>
            ...
            <h6 style={{marginLeft:"25px", color:"#2699c7"}}>METHOD-1</h6>
            ...
            <h6 style={{marginLeft:"25px", color:"#2699c7", marginTop: "25px"}}>METHOD-2</h6>
            <ol>
                <li>
                    Make sure that you installed <span style={{fontWeight: "bolder"}}>git</span>.
                    <p>Click <a className="repoLink" style={{color:"#2699c7"}} href="https://git-scm.com/downloads" rel="noopener noreffer" target="_blank">here </a>to install git.</p>
                </li>
                <li>
            ...
            <p style={{marginLeft:"25px", marginTop:"20px"}}>Add the command <span style={{color: "#2699c7", fontWeight: "bold"}}>"git add ." </span>before commiting, so to add all the files to the repository.</p>
        </div>    
    )
}
